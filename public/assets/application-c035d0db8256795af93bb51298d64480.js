...
$(function() {
	$(document).on("click","#book_classes th a, #book_classes .pagination a", function() {
	$.getScript(this.href);
	return false;
});
$("#book_classes_search input").keyup(function() {
	$.get($("#book_classes_search").attr("action"), $("#book_classes_search").serialize(), null, "script");
	return false;
	});
});
